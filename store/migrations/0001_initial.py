# Generated by Django 5.2.4 on 2025-08-16 18:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text="Используется для URL, например 'videokarty'", max_length=255, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='products/%Y/%m/%d', verbose_name='Изображения')),
